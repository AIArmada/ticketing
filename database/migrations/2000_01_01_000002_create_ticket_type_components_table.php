...
return new class extends Migration
{
    public function up(): void
    {
        ...
        commerce_schema_create_if_missing(config('ticketing.database.tables.ticket_type_components', 'ticket_type_components'), function (Blueprint $table) use ($jsonType): void {
